...
export const PRESETS: PresetDefinition[] = [
  preset("preset-dirt-roads", "Dirt / gravel / unpaved roads", "Unpaved roads and tracks drivable by a Jeep or similar 4x4 — gravel, dirt, sand, mud, grass, and graded tracks. Excludes footways, bridleways, and routes tagged impassable.", 14, false, false, false),
